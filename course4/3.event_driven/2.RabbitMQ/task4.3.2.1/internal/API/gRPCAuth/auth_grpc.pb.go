...
const (
	AuthService_VerifyToken_FullMethodName = "/gRPCAuth.AuthService/VerifyToken"
)
...
func (c *authServiceClient) VerifyToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*User, error) {
...
func (UnimplementedAuthServiceServer) VerifyToken(context.Context, *Token) (*User, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gRPCAuth.AuthService",
