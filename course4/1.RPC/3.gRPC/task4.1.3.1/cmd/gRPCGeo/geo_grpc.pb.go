...
const (
	GeoService_SearchAnswer_FullMethodName  = "/gRPCGeo.GeoService/SearchAnswer"
	GeoService_GeocodeAnswer_FullMethodName = "/gRPCGeo.GeoService/GeocodeAnswer"
)
...
type GeoServiceClient interface {
	SearchAnswer(ctx context.Context, in *RequestAddressGeocode, opts ...grpc.CallOption) (*ResponseAddress, error)
	GeocodeAnswer(ctx context.Context, in *Address, opts ...grpc.CallOption) (*ResponseAddressGeocode, error)
}
...
func (c *geoServiceClient) SearchAnswer(ctx context.Context, in *RequestAddressGeocode, opts ...grpc.CallOption) (*ResponseAddress, error) {
...
func (c *geoServiceClient) GeocodeAnswer(ctx context.Context, in *Address, opts ...grpc.CallOption) (*ResponseAddressGeocode, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseAddressGeocode)
...
type GeoServiceServer interface {
	SearchAnswer(context.Context, *RequestAddressGeocode) (*ResponseAddress, error)
	GeocodeAnswer(context.Context, *Address) (*ResponseAddressGeocode, error)
...
func (UnimplementedGeoServiceServer) SearchAnswer(context.Context, *RequestAddressGeocode) (*ResponseAddress, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchAnswer not implemented")
}
func (UnimplementedGeoServiceServer) GeocodeAnswer(context.Context, *Address) (*ResponseAddressGeocode, error) {
...
func _GeoService_SearchAnswer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GeoServiceServer).SearchAnswer(ctx, req.(*RequestAddressGeocode))
	}
...
var GeoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gRPCGeo.GeoService",
	...
	Metadata: "cmd/gRPCGeo/geo.proto",
}
