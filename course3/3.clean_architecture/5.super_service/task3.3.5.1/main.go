// Реализуй  применение  супер  сервисов  и  фасадов  в  программе  на  языке  Golang  с  использованием
// принципов чистой архитектуры.
// Программа должна содержать следующие компоненты:
// Супер   сервисы   —   высокоуровневые   сервисы,   которые   объединяют   несколько   низкоуровневых
// сервисов и предоставляют удобный интерфейс для работы с ними.
// Фасады — классы или функции, которые предоставляют упрощенный интерфейс для
// взаимодействия
// со сложной системой или подсистемой.
// Задача — продемонстрировать применение супер сервисов и фасадов в контексте конкретной программы
// на языке Golang. Ты можешь выбрать любую программу или функциональность, где эти концепции могут
// быть применены
